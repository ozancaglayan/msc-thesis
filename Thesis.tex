...
%%% Experiment Setup %%%
%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{Experiment Protocol}
...
\par{
    ...
    $O1$ and $O2$ where SSVEP response is prominent \citep{herrmann_human_2001}.
    The acquired data is then sent to the SP block for signal processing
