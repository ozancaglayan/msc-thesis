...
\par{
    ...
    \end{itemize}
    According to this categorization, passive BCIs embraces the systems
...
\par{
    ...
    the type of CNS tissue made of neurons. Each cerebral hemisphere is further divided
...
\begin{figure}[ht]
    ...
    \caption{Functional regions of the cerebral cortex.}
...
\begin{table}
    ...
    \begin{tabular}{l l}
        \hline
        Frontal Lobe & Movement control (\emph{Primary motor cortex (M1)}\\ \hline
