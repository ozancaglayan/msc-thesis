...
\par{
    \emph{Passive} electrodes are simple metal disks generally made of tin, gold, silver
...
\par{
    ...
    leaves pasty residue that will not go away without washing. \emph{Dry} electrodes
...
\par {
    ...
    compared to expensive and sophisticated active electrodes.
}
