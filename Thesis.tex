...
\par{
    ...
    \emph{partially-invasive} technique \citep{demetriades_brain-machine_2010}. \vspace*{0.2cm}
    \begin{figure}[ht]
        \centering
        \includegraphics[scale=0.6]{images/eeg_vs_ecog}
...
\par{
    ...
    which is injected to the O2 electrode of the headset.
}
\par{
...
\par{
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[scale=0.65]{images/workflow2}
...
\mysubsection{Results and Discussion}
\par{
    ...
    The plots of averaged PSD estimation for a subject with short hair (OC) and a subject with long hair (PU) are
    respectively presented in Figure ~\ref{fig:results_OC} and ~\ref{fig:results_PU}.
}
\par{
    A classification rate of $\%100$ has been achieved in both sessions for the subject OC while
    $\%66.7$ and $\%83.3$ were reached by the subject PU.
}
\par{
    The misclassification can be caused by several reasons including movement related artifacts or
    poor conductivity (especially for the subject PU with long hair).
    Artifact rejection methods can be dynamically applied to the data during the acquisition
    to eliminate noisy trials or chunks of EEG.
}
\par{
    It can also be observed empirically that the PSD estimate at the 1\textsuperscript{st} harmonic
    is more significant compared to the neighborhood of the 2\textsuperscript{nd} harmonic. So a scoring method
    solely based around the 1\textsuperscript{st} harmonic may improve the classification rate.
}
\par{
    Finally, the relationship between the duration of a single EEG chunk (which is currently set to 2 seconds)
    and the SNR of the smoothed spectrum can be analyzed to see whether increasing the duration improves
    the SNR or not.
}
\newpage
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.75]{images/results-psd-OC_23-01-2014-16-04}
        \label{fig:results_oc_1}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.75]{images/results-psd-OC_23-01-2014-19-56}
        \label{fig:results_oc_2}
    \end{subfigure}
    \caption{Averaged PSD Estimation of Subject OC}
...
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.75]{images/results-psd-PU_23-01-2014-18-48}
        \label{fig:results_pu_1}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[scale=0.75]{images/results-psd-PU_23-01-2014-18-59}
        \label{fig:results_pu_2}
    \end{subfigure}
    \caption[Averaged PSD Estimation of Subject PU]{Averaged PSD estimation of subject PU. Misclassified trials are drawn with dashed lines}
