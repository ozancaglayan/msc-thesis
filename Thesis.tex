...
\mysubsubsection{Kondo KHR-3HV Humanoid Robot}\label{seq:kondo}
\par{
    \begin{figure}[ht]
        \centering
...
\mysubsubsection{BeagleBone Black}\label{seq:embeddedcomputer_bbb}
...
\mysubsubsubsection{Programmable Realtime Unit}\label{seq:embeddedcomputer_bbb_pru}
\par{
...
\mysubsubsection{Emotiv EEG}\label{seq:emotiveeg}
...
\mysubsubsubsection{Official Software Development Kit (SDK)}\label{seq:emotiveeg_sdk}
...
\mysubsubsubsection{Open-Source Protocol}\label{seq:emotiveeg_opensource}
...
\mysubsubsubsection{Python-emotiv}\label{seq:emotiveeg_python_emotiv}
\par{
