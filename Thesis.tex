...
\mysubsubsection{SSVEP Stimulation on BBB}\label{seq:embeddedcomputer_stimuligen}
\par{
...
\mysubsubsection{SSVEP Stimulation Software}\label{seq:embeddedcomputer_stimuligen_software}
\par{
