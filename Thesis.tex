...
\par{
    The locked-in syndrome (\nomenclature{LIS}{Locked-in Syndrome}) is a medical condition in which patients are awake and conscious but 
...
\par {
    Amyotrophic Lateral Sclerosis (\nomenclature{ALS}{Amyotrophic Lateral Sclerosis}), also known as Lou Gehrig's disease (Lou Gehrig is a popular baseball
...
\par{
    ...
    Brain-Computer Interfaces (\nomenclature{BCI}{Brain-Computer Interface}) or
