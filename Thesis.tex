...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Averaged PSD Estimates of Subject OC}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption[Averaged PSD Estimates of Subject PU]{Averaged PSD estimates of subject PU. Misclassification is represented with dashed lines}
