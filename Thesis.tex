...
\par{
    ...
    Although new consumer grade wireless EEG headsets are recently gaining popularity,
    most of the BCI research depends on high quality but bulky and expensive acquisition systems.
...
\par{
    ...
    EEG sans fil gagnent en popularité récemment, la plupart des recherches
    dépend de systèmes d'acquisition encombrants et coûteux de haute qualité. En combinaison avec un
